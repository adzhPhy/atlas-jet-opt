...
files = [f"user.tapark.42500064._00000{x}.tree.root" for x in range(1,10)] + [f"user.tapark.42500064._00001{x}.tree.root" for x in range(0,2)]
...
plt.savefig('PFlow_JZ2_leadingJetDistPT.png')
e1 = time.time()
print(f"Data Set PFlow_JZ2 done in {e1-s1:.2f} seconds")